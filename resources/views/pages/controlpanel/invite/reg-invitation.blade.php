                  ...
                  <div class="authentication-inner">
                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <p class="mb-4">You can Register as Employee</p>
                        ...
                        <form method="POST" action="{{route('store_invitation')}}>
                          ...
                          <div class="mb-3">
                            ...
                            <input type="email" class="form-control"  id="email" name="email" value="{{$user->email}}"  required autocomplete="username" readonly/>
